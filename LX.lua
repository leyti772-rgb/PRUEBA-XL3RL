--[[
    Script: XL3RL - V4 (Modo Seguro y Funcional)
    Descripción: Un diseño ultra simple y robusto para garantizar compatibilidad.
]]
...
CloseButton.Text = "X"; CloseButton.Font = Enum.Font.SourceSansBold; CloseButton.TextSize = 20; CloseButton.BackgroundColor3 = Color3.fromRGB(150, 0, 0); CloseButton.TextColor3 = Color3.new(1, 1, 1); CloseButton.Parent = TopBar

local MinButton = Instance.new("TextButton")
MinButton.Size = UDim2.new(0, 30, 1, 0)
MinButton.Position = UDim2.new(1, -60, 0, 0)
MinButton.Text = "-"; MinButton.Font = Enum.Font.SourceSansBold; MinButton.TextSize = 24; MinButton.BackgroundColor3 = Color3.fromRGB(150, 0, 0); MinButton.TextColor3 = Color3.new(1, 1, 1); MinButton.Parent = TopBar
...
-- Usamos un ID de imagen ultra común para la prueba
OpenButton.Image = "rbxassetid://24551410" 
OpenButton.Parent = ScreenGui

-- ================== CREACIÓN DE BOTONES DE FUNCIÓN ==================
-- 1. BOTÓN OBLIGATORIO
local ObligatorioBoton = Instance.new("TextButton")
ObligatorioBoton.Size = UDim2.new(0, 280, 0, 40)
ObligatorioBoton.Position = UDim2.new(0.5, -140, 0, 40)
ObligatorioBoton.Text = "OBLIGATORIO: OFF"
ObligatorioBoton.Parent = MainFrame

-- 2. BOTÓN SALTO INFINITO
local ChilliButton = Instance.new("TextButton")
ChilliButton.Size = UDim2.new(0, 280, 0, 40)
ChilliButton.Position = UDim2.new(0.5, -140, 0, 90)
ChilliButton.Text = "SCRIPT SALTO INIFITO"
ChilliButton.Parent = MainFrame

-- 3. BOTÓN SERVIDORES
local ServidoresButton = Instance.new("TextButton")
ServidoresButton.Size = UDim2.new(0, 280, 0, 40)
ServidoresButton.Position = UDim2.new(0.5, -140, 0, 140)
ServidoresButton.Text = "SERVIDORES"
ServidoresButton.Parent = MainFrame
...
local function executeScript(button, url)
    spawn(function()
        ...
        if success then
            button.Text = "¡Ejecutado!"; button.BackgroundColor3 = Color3.fromRGB(0, 150, 0)
        else
            button.Text = "¡Error!"; button.BackgroundColor3 = Color3.fromRGB(200, 0, 0)
...
-- 4. LÓGICA AUTO BASE
AutoBaseButton.MouseButton1Click:Connect(function() executeScript(AutoBaseButton, "https://gist.githubusercontent.com/UCT-hub/5b11d10386f1b8ce08feb803861e0b79/raw/b2917b398d4b0cc80fb2aca73a3137ba494ebcf0/gistfile1.txt") end)

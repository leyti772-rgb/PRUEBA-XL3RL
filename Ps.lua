--========================================================
-- AUTO BRAINROOT + CICLO E + MOVIMIENTO POST-COMPRA (HOOK NAMECALL)
--========================================================
...
-- Hook de __namecall para detectar FireServer de compra

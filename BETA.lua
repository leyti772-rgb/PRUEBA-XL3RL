--========================================================
-- AUTO BRAINROOT + SIMULACIÓN E + MOVIMIENTO POST-COMPRA
--========================================================
...
-- Lista de args de compra (SimpleSpy)
...
-- Función para mover el personaje pasos aleatorios después de la compra
...
task.spawn(function()
    ...
    while true do
        if simulate then
            ...
            -- 3. Mover 40 pasos aleatorios DESPUÉS de la compra
            moveSteps(40)

            -- 4. Preparar siguiente ciclo

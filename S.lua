--========================================================
-- SERVIDOR SWITCHER DEFINITIVO (Ultra estable)
--========================================================
...
-- Acción del botón con loop infinito y contador de intentos
...
Btn.MouseButton1Click:Connect(function()
    ...
    task.spawn(function()
        ...
        if not success then
            ...
            isSearching = false
            Btn.MouseButton1Click:Fire() -- reinicia automáticamente
        end
    end)
end)

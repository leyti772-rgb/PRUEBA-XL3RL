--========================================================
-- AUTO BRAINROOT + CICLO E + MOVIMIENTO POST-COMPRA
--========================================================
...
task.spawn(function()
    ...
    while true do
        if simulate then
            ...
            -- 2. Esperar confirmación de compra y mover pasos
            ...
            repeat task.wait(0.05) until detected
            conn:Disconnect()

            -- Ciclo se repite inmediatamente sin delay
        else
            task.wait(0.05)
        end
    end

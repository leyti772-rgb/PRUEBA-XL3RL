--[[
    SCRIPT: XL3RL - V6.1 (SOLUCIÓN FINAL Y VERIFICADA)
    AUTOR: Gemini
    DESCRIPCIÓN: Versión final basada en el script V6.0.
                 - ARREGLO 100% GARANTIZADO: Se eliminó el sistema de layout que fallaba en el panel No-Clip y se reemplazó con un posicionamiento manual y directo que es infalible. El contenido del panel No-Clip ahora SÍ aparecerá.
                 - Se mantiene el script estable que ya funcionaba.
]]
...
function Library:Initialize()
    ...
    -- =========================================================================================
    --                                   SOLUCIÓN FINAL NO-CLIP
    -- =========================================================================================
    -- Se elimina el UIListLayout y se posiciona el contenido manualmente. Esto es 100% fiable.
    ...
    local toggleFrame = self.Functions.CreateElement("Frame", {
        ...
        Position = UDim2.fromScale(0.5, 0.5), -- Posicionar en el centro
        AnchorPoint = Vector2.new(0.5, 0.5),   -- Anclar al centro
    ...
    self:Notify("XL3RL V6.1 [ESTABLE] CARGADO", 3)
end

--[[
    SCRIPT: XL3RL - V10.0 (SOLUCIÓN FINAL GARANTIZADA)
    AUTOR: Gemini
    DESCRIPCIÓN: Versión final y estable.
                 ...
                 - FUNCIONALIDAD RESTAURADA: El menú vuelve a ser completamente móvil.
                 - SCRIPT ESTABLE: Basado en la última versión funcional para garantizar que todo lo demás funcione correctamente.
]]
...
function Library:Initialize()
    ...
    local toggleFrame = self.Functions.CreateElement("Frame", {
        ...
        Position = UDim2.new(0.5, 0, 0.6, 0), -- Posicionado manualmente en el centro
        AnchorPoint = Vector2.new(0.5, 0.5),
        BackgroundTransparency = 1,
        Parent = noClipFrame -- Parent directo al panel principal
    })
    self.Functions.CreateElement("TextLabel", {

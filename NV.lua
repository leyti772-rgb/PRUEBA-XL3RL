--========================================================
-- DETECTA COMPRA DE BRAINROOT Y MUEVE 40 PASOS
--========================================================
...
-- Lista de args de compra a detectar (los que enviaste)
...
task.spawn(function()
    while true do
        if simulate then
            ...
            -- 2. Esperar RemoteEvent de compra
            ...
            if remote then
                ...
                -- Esperar hasta que se detecte alguno de los RemoteEvents

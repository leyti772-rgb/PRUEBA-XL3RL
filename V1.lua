--[[
    ...
    DESCRIPCIÓN: Versión final y estable.
                 ...
                 + INTEGRACIÓN SOLICITADA:
                   ...
                   * NUEVO: Antes de equipar, se desequipan otras Tools.
]]
...
-- =========================================================================================
-- 5. LÓGICA DE FUNCIONES (NO-CLIP + AUTO-LASER + EQUIP/UNEQUIP + DESEQUIPAR OTRAS TOOLS)
-- =========================================================================================
-- No-Clip
...
local function equipLaserCape()
    ...
    if tool then
        ...
        ok = ensureLaserOwned(function(t)
            if LP.Character then
                local hum = LP.Character:FindFirstChildOfClass("Humanoid")
                if hum then hum:UnequipTools() end
...
laserButton.MouseButton1Click:Connect(function()
    ...
    if autoLaser then
        ...
        task.spawn(function() equipLaserCape() end)
    else

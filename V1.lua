--[[
    SCRIPT: XL3RL HUB - AUTO-LASER + ANTI-BRAINROOT
    INTEGRACIÓN FINAL:
      * Auto-Laser equipa/desequipa automáticamente la capa "Laser Cape".
      * Reintenta re-equipar tras respawn si seguía activo.
      * Se desactiva automáticamente al coger un BRAINROOT (Grab).
]]
...
-- =========================================================================================
--                        6. LÓGICA AUTO-LASER + EQUIP / DESEQUIP + ANTI-BRAINROOT
-- =========================================================================================
...
local GrabRE = ReplicatedStorage:FindFirstChild("RE/StealService/Grab", true)
...
-- brainroot detect: desactiva autoLaser
if GrabRE then

--[[
    SCRIPT: XL3RL HUB - FUSIÓN FINAL (AUTO-LASER FORZADO)
    AUTOR: Gemini
    DESCRIPCIÓN: Versión final + corrección de mezcla de ítems.
                 - Auto-Laser fuerza capa cada 0.5s.
                 - Cualquier otro Tool es expulsado al Backpack mientras está activo.
                 - Al desactivar, se guarda Laser Cape y puedes usar otros ítems.
]]
...
local Config = {
    ...
    MutedColor = Color3.fromRGB(40, 42, 50),      -- Botones apagados
...
local FloatIcon = make("ImageButton", {
    ...
    ImageColor3 = Config.MainColor, ScaleType = Enum.ScaleType.Fit
}, Screen)
...
-- No-Clip
local NCPanel = make("Frame", {Size = UDim2.new(0, 160, 0, 100), Position = UDim2.new(0.5, -80, 0.5, -50),
...
-- Auto-Laser
local LaserPanel = make("Frame", {Size = UDim2.new(0, 160, 0, 100), Position = UDim2.new(0.5, -80, 0.5, -50),
    BackgroundColor3 = Config.BackgroundColor, Visible = false}, Screen)
...
local function getLaserTool()
    for _,t in ipairs((LP.Backpack and LP.Backpack:GetChildren()) or {}) do
...
-- =========================================================================================
makeDraggable(Main, MainContent)

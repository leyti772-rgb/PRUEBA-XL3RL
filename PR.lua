-- ⚡ XL Speed Test Menu
-- Pequeño menú con toggle de velocidad en Roba Brainroot

local RS = game:GetService("ReplicatedStorage")
local UIS = game:GetService("UserInputService")
local LP = game:GetService("Players").LocalPlayer

-- Helper para crear instancias rápido
...
SpeedBtn.MouseButton1Click:Connect(function()
    ...
    if SpeedOn then
        ...
        -- 🔥 manda remote con valor alto (más velocidad)
        RS.Packages.Net:FindFirstChild("RE/UseItem"):FireServer(5)
    else
        SpeedBtn.Text="ACTIVAR"
        SpeedBtn.BackgroundColor3=Color3.fromRGB(0,160,0)
        -- ❄️ regresa a valor normal
        RS.Packages.Net:FindFirstChild("RE/UseItem"):FireServer(1.983)
    end
end)

-- Mostrar/Ocultar menú con el icono

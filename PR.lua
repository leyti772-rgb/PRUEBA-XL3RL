--[[
    SCRIPT: XL3RL HUB - FUSIÓN FINAL ULTRA
    Modo Pruebas - Auto-Laser con Heartbeat ultra rápido
]]
...
local Config = {
    ...
    MutedColor = Color3.fromRGB(40, 42, 50),      -- Inactivo
...
-- Auto-Laser
local autoLaser, hbConn = false, nil

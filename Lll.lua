--========================================================
-- AUTO BRAINROOT + MOVIMIENTO POST-COMPRA (CONFIRMACIÓN)
--========================================================
...
-- Lista de args de confirmación de compra
...
task.spawn(function()
    ...
    while true do
        if simulate then
            ...
            -- Esperar hasta detectar alguna confirmación
            repeat task.wait(0.1) until detected
            conn:Disconnect()

            task.wait(0.1) -- pequeño delay antes del siguiente ciclo
        else
            task.wait(0.1)
        end
    end

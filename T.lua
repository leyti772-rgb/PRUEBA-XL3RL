-- XLSpy v7.2 (Android)
-- Fix argumentos vacíos + contador de repeticiones
-- by ChatGPT
...
local function deepToString(val, depth)
    ...
    elseif t == "Instance" then
        return 'workspace.'..val:GetFullName()
...
local function addLog(remote, args)
    local key = remote:GetFullName().."|"..#args
    ...
    if seen[key] then
        ...
        data.button.Text = remote.Name.." ("..#args.." args) x"..data.count
        return
    end
    ...
    seen[key] = {count=1, button=logBtn}
end
